      ...
      <v-col md="10">
        <v-card>
          <v-banner single-line tile>
            <v-chip class="ma-2" color="#F0E68C" label text-color="#696969">
            ...
            <template v-slot:actions>
              <v-btn color="#6A5ACD" text v-on:click="collect">
                <v-icon :color="section_data.is_collected ? 'orange' : 'grey'"
                  >mdi-star</v-icon
                >
                收藏
              </v-btn>
      ...
      <v-col md="10">
        <v-card>
          ...
          >
            ...
            <v-tab @change="refresh_list"> 全部帖子 </v-tab>
            <v-tab
        ...
        <v-card>
          <v-list subheader tile min-height="600" max-height="1000">
            <v-list-item-group active-class="brown--text">
              <template>
                <v-list-item
                  v-for="item in section_data.posts"
                  :key="item.id"
